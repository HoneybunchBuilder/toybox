...
enum GLTF_PERMUTATIONS {
  ...
  // GLTF_PERM_CLEARCOAT = 0x00000008,
  // GLTF_PERM_TRANSMISSION = 0x00000010,
  // GLTF_PERM_IOR = 0x00000020,
  // GLTF_PERM_SPECULAR = 0x00000040,
  // GLTF_PERM_UNLIT = 0x00000080,
  GLTF_PERM_FLAG_COUNT = 2,
