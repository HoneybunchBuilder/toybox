...
// https://github.com/cimgui/cimgui based on imgui.h file version "1.89.9" 18990
...
CIMGUI_API void igPopTabStop() { return ImGui::PopTabStop(); }
...
CIMGUI_API bool igImageButton(const char *str_id, ImTextureID user_texture_id,
...
CIMGUI_API bool igBeginItemTooltip() { return ImGui::BeginItemTooltip(); }
...
CIMGUI_API void ImGuiIO_AddMouseWheelEvent(ImGuiIO *self, float wheel_x,
                                           float wheel_y) {
...
ImDrawList_ImDrawList(ImDrawListSharedData *shared_data) {
...
CIMGUI_API void ImFont_RenderChar(ImFont *self, ImDrawList *draw_list,
                                  float size, const ImVec2 pos, ImU32 col,
                                  ImWchar c) {
...
CIMGUI_API ImGuiID igImHashStr(const char *data, size_t data_size,
                               ImGuiID seed) {
...
CIMGUI_API char igImToUpper(char c) { return ImToUpper(c); }
...
CIMGUI_API void ImGuiTextIndex_append(ImGuiTextIndex *self, const char *base,
...
CIMGUI_API void
ImGuiInputTextDeactivatedState_destroy(ImGuiInputTextDeactivatedState *self) {
  IM_DELETE(self);
}
...
CIMGUI_API ImGuiKeyRoutingTable *
ImGuiKeyRoutingTable_ImGuiKeyRoutingTable(void) {
...
CIMGUI_API void
igSetWindowHiddendAndSkipItemsForCurrentFrame(ImGuiWindow *window) {
...
CIMGUI_API void igWindowPosRelToAbs(ImVec2 *pOut, ImGuiWindow *window,
                                    const ImVec2 p) {
...
CIMGUI_API void igInitialize() { return ImGui::Initialize(); }
CIMGUI_API void igShutdown() { return ImGui::Shutdown(); }
...
CIMGUI_API ImGuiWindowSettings *
igFindWindowSettingsByWindow(ImGuiWindow *window) {
...
CIMGUI_API void
igNavMoveRequestResolveWithPastTreeNode(ImGuiNavItemData *result,
...
CIMGUI_API void igFocusItem() { return ImGui::FocusItem(); }
...
CIMGUI_API bool igIsMouseKey(ImGuiKey key) { return ImGui::IsMouseKey(key); }
CIMGUI_API bool igIsAliasKey(ImGuiKey key) { return ImGui::IsAliasKey(key); }
...
CIMGUI_API void igGetKeyChordName(ImGuiKeyChord key_chord, char *out_buf,
                                  int out_buf_size) {
...
CIMGUI_API void igGetKeyMagnitude2d(ImVec2 *pOut, ImGuiKey key_left,
...
CIMGUI_API void igSetKeyOwner(ImGuiKey key, ImGuiID owner_id,
                              ImGuiInputFlags flags) {
  return ImGui::SetKeyOwner(key, owner_id, flags);
}
CIMGUI_API void igSetKeyOwnersForKeyChord(ImGuiKeyChord key, ImGuiID owner_id,
                                          ImGuiInputFlags flags) {
...
CIMGUI_API bool igIsKeyPressed_ID(ImGuiKey key, ImGuiID owner_id,
                                  ImGuiInputFlags flags) {
...
CIMGUI_API bool igIsMouseClicked_ID(ImGuiMouseButton button, ImGuiID owner_id,
                                    ImGuiInputFlags flags) {
...
CIMGUI_API bool igShortcut(ImGuiKeyChord key_chord, ImGuiID owner_id,
                           ImGuiInputFlags flags) {
  return ImGui::Shortcut(key_chord, owner_id, flags);
}
CIMGUI_API bool igSetShortcutRouting(ImGuiKeyChord key_chord, ImGuiID owner_id,
                                     ImGuiInputFlags flags) {
...
CIMGUI_API ImGuiKeyRoutingData *
igGetShortcutRoutingData(ImGuiKeyChord key_chord) {
...
CIMGUI_API bool igIsDragDropActive() { return ImGui::IsDragDropActive(); }
...
CIMGUI_API int igTableGetHoveredRow() { return ImGui::TableGetHoveredRow(); }
...
CIMGUI_API ImGuiID igTableGetColumnResizeID(ImGuiTable *table, int column_n,
                                            int instance_no) {
...
CIMGUI_API void igTabBarQueueReorder(ImGuiTabBar *tab_bar, ImGuiTabItem *tab,
                                     int offset) {
...
CIMGUI_API void igTabItemCalcSize_Str(ImVec2 *pOut, const char *label,
...
CIMGUI_API void igRenderMouseCursor(ImVec2 pos, float scale,
...
CIMGUI_API void igSeparatorTextEx(ImGuiID id, const char *label,
